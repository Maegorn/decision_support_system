...
class Node:
    ...
    def state(self):
        ...
        Restituisce una rappresentazione tabella hash di sé
        """
        return str(self)
    ...
    def path(self):
        ...
        Ricostruire un percorso dalla radice al 'genitore'
        """
        node, p = self, []
        while node:
            p.append(node)
    ...
    def solved(self):
        """ Wrapper to check if 'puzzle' is solved
            per verificare se 'rompicapo' è risolto"""
        return self.puzzle.solved

    @property
    def actions(self):
        """ Wrapper for 'actions' accessible at current state
            per 'azioni' accessibile a stato attuale"""
        ...
        while queue:
            ...
            for move, action in node.actions:
                ...
                if child.state not in seen:
                    queue.append(child) #change to append from appendleft cause depth first take the rightmost node
...
class Puzzle:
    ...
    def solved(self):
       ...
       - Il puzzle è risolto se i numeri della scheda appiattita sono in
         ordine crescente da sinistra a destra e '0' piastrella è in
         ultima posizione sulla scheda
        """
...
         ultima posizione sulla scheda...
    ...
    def shuffle(self):
        ...
        Restituisce un nuovo puzzle che è stato mischiato con 1000
        movimenti casuali
        """
        puzzle = self
        for _ in range(1000):
...
for node in p:
    print(node.action)
    node.puzzle.pprint()
punto_fine=time.time()
print("Ha impiegato", punto_fine - punto_inizio, "secondi")
